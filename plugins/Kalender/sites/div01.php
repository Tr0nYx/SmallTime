    ...
    <tr>
        ...
        <td valign='middle' align='left'>
            <a title='Monat <?php echo $_last->_monatname ?>'
               href='?action=plugins&timestamp=<?php echo $_last->_timestamp ?>'>
        ...
        <td valign='middle' class='td_background_info' align='left'>
            <a title='Monat <?php echo $_time->_monatname ?>'
               href='?action=plugins&timestamp=<?php echo $_time->_timestamp ?>'>
                <u><?php echo $_time->_monatname ?><?php echo $_time->_jahr ?></u>
            </a>
        </td>
        <td valign='middle' class='td_background_info' align='right'>
            <a title='Excel - Export'
               href='?action=plugins&timestamp=<?php echo $_time->_timestamp ?>&excel=kalender'><img
        ...
        <td valign='middle' align='left'>
            <a title='Monat <?php echo $_next->_monatname ?>'
               href='?action=plugins&timestamp=<?php echo $_next->_timestamp ?>'>
