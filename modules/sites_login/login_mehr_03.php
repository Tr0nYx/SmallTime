...
if (strstr($_template->_bootstrap, 'true')) {
    ...
    <form class="form-horizontal" style="padding: 5px;" name="login"
        ...
        <input class="form-control" id="inputname" type='text' name='_n' value='' size='20' onfocus="this.value=''">
        ...
        <input class="form-control" id="inputpasswd" type='password' name='_p' value='' size='20' onfocus="this.value=''">
