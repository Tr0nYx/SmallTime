...
<?php } ?>
<form name="insert" action="?action=update_time&timestamp=<?php echo $_time->_timestamp ?>&token=<?php echo $token ?>"
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="2">
        <tr>
            ...
            <td class=td_background_tag align=left>
                <?php echo $_time->_tag."."; ?><input type="hidden" type="text" name="_w_tag"
                                                      value="<?php echo $_time->_tag; ?>" size="4">
                <?php echo $_time->_monat."."; ?><input type="hidden" type="text" name="_w_monat"
                                                        value="<?php echo $_time->_monat; ?>" size="4">
                <?php echo $_time->_jahr; ?><input type="hidden" type="text" name="_w_jahr"
                                                   value="<?php echo $_time->_jahr; ?>" size="4">
            </td>
        </tr>
