...
<form action="?action=insert_absenz&timestamp=<?php echo $_time->_timestamp ?>&token=<?php echo $token ?>" method="post"
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="2">
        <tr>
            <td class=td_background_wochenende width="300" align=left>Absenzen Grund f&uuml;r den
                : <?php echo date("d.m.y", $_time->_timestamp); ?></td>
        ...
        <tr>
            <td class=td_background_heute align=left width="50%" align="center">
                <?php if (!strstr($_template->_jquery, 'true')) { ?> <input type='submit' name='absenden'
                                                                            value='CANCEL'><?php } ?>
            </td>
            <td class=td_background_heute align=left width="50%" align="center">
