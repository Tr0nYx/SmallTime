...
?>
<form action="?action=user_personalkarte&admin_id=<?php echo $_SESSION['id'] ?>" method="post"
    ...
    <table border=0 height="100%" width="100%" cellpadding=3 cellspacing=1>
        <tr>
            <td valign="top" width="250" align="left" rowspan="<?php echo $_count ?>">
                <img src="<?php echo $_bild."?".time() ?>" alt="" id="foto" width="250"/><br/><br/>
                <hr>
        ...
        <tr>
            ...
            <td class="alert alert-error table-danger" align="center" colspan="2">
