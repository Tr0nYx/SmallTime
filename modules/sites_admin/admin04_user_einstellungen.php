...
<form action='?action=user_einstellungen_update&admin_id=<?php echo $_id; ?>' method='post' target='_self'>
    <table width=100% border=0 cellpadding=3 cellspacing=1>
        ...
        <tr>
            ...
            <td align=left class=td_background_tag><input type='text' name='_b'
                                                          value='<?php echo $_users->_array[$_id][1] ?>' size='70'></td>
            <td align=left class=td_background_tag width=16><img
                        title='Loginnname, ohne Sonderzeichen, leerschl&auml;ge oder Umlaute!'
        ...
        <tr>
            ...
            <td align=left class=td_background_tag width=16><img title='Neues Passwort.'
                                                                 src='images/icons/information.png' border=0></td>
        </tr>
        <tr>
            <td align=left class=td_background_tag>RFID - Chipnummer (idtime.php?rfid=XXXXX)</td>
            <td align=left class=td_background_tag><input type='text' name='_d'
                                                          value='<?php echo $_users->_array[$_id][3] ?>' size='70'></td>
            <td align=left class=td_background_tag width=16><img title='RFID - Nummer.'
                                                                 src='images/icons/information.png' border=0></td>
        </tr>
        <tr>
