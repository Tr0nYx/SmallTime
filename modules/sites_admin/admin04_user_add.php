    ...
    <table width=100% border=0 cellpadding=3 cellspacing=1>
        <tr>
            ...
            <td align=left class=td_background_tag width=16>
                <img title='Pfad zu den Daten f&uuml;r diesen Benutzer. Ohne Sonderzeichen, leerschl&auml;ge oder Umlaute!'
                     src='images/icons/information.png' border=0>
            </td>
        </tr>
        <tr>
            <td align=left class=td_background_tag>
            ...
            <td align=left class=td_background_tag width=16>
                <img title='Loginnname, ohne Sonderzeichen, leerschl&auml;ge oder Umlaute!'
                     src='images/icons/information.png' border=0>
            </td>
        </tr>
        <tr>
