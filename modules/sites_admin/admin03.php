...
echo "<table class=\"table\" border=0 cellpadding=5 cellspacing=1>";
...
foreach ($_benutzer as $string) {
    ...
    if ($_user->_loginname == $string[1]) {
        echo "<td class='td_background_info' align=left>";
    } else {
    ...
    if ($_action == 'show_time' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'show_year2' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'show_year' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'show_pdf' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'zip_user' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'user_einstellungen' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'user_edit' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
               ...
               <span class='btn btn-light";
    if ($_action == 'user_edit_absenzen' && $i == $_SESSION['id']) {
        echo ' active';
    }
    echo "'>
