...
<form action="?action=user_update_absenzen&admin_id=<?php echo $_id ?>" method="post" target="_self">
    <table width="100%" border="0" cellpadding="5" cellspacing="1 	">
        <tr>
            <td colspan=3 class=td_background_wochenende width="100%" align=left>Absenz - Auswahl einstellen
                (Bezeichnung, Kurzzeichen, &Uuml;bernommen wird in ?% von der Firma)
                <br>ACHTUNG: Es kann zu Fehlern f&uuml;ren wenn schon eine Absenz mit dem Kurzzeichen existiert und es
                ge&auml;ndert wird!
            </td>
        </tr>
        <tr>
            ...
            <td class=td_background_top align=center width="10%">
                Kurzzeichen
            </td>
