...
foreach ($_settings->_array as $_zeile) {
    ...
    if ($y == 12) {
        ...
        if ($_settings->_array[$y][1] == 1) {
            $check1 = " checked ";
        }
        if ($_settings->_array[$y][1] == 2) {
            $check2 = " checked ";
        }
        if ($_settings->_array[$y][1] == 3) {
            $check3 = " checked ";
        }
        if ($_settings->_array[$y][1] == 4) {
            $check4 = " checked ";
        }
...
if ($_settings->_array[24][1] == 1) {
    $check1 = " checked ";
} else {
    $check1 = "";
}
if ($_settings->_array[24][1] == 0) {
    $check2 = " checked ";
} else {
    $check2 = "";
}
...
if ($_settings->_array[26][1] == 1) {
    $check1 = " checked ";
} else {
    $check1 = "";
}
if ($_settings->_array[26][1] == 0) {
    $check2 = " checked ";
} else {
    $check2 = "";
}
...
if ($_settings->_array[27][1] == 1) {
    $check1 = " checked ";
} else {
    $check1 = "";
}
if ($_settings->_array[27][1] == 0) {
    $check2 = " checked ";
} else {
    $check2 = "";
}
...
if ($_settings->_array[28][1] == 1) {
    $check1 = " checked ";
} else {
    $check1 = "";
}
if ($_settings->_array[28][1] == 0) {
    $check2 = " checked ";
} else {
    $check2 = "";
}
