        ...
        if (strpos($pausen[0], 'Daten') == false) {
            ...
            foreach ($pausen as $pause) {
                ...
                <tr>
                    ...
                    <td class="td3">
                        <input type="text" size="2" name="time1_<?php echo $p ?>" value="<?php echo $pause[0] ?>"
                               style="width:80px;">
                    </td>
                    <td class="td3">
                        <input type="text" size="2" name="time2_<?php echo $p ?>" value="<?php echo $pause[1] ?>"
                               style="width:80px;">
                    </td>
                    <td>
                        <input type="text" size="2" name="pause_<?php echo $p ?>" value="<?php echo $pause[2] ?>"
                               style="width:80px;">
                    </td>
                </tr>
                <?php
