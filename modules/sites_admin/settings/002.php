...
<form method="POST" action="?action=settings&menue=multilogin">
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <td class="td_background_tag" align="center"><input type="checkbox" name="01" value="1"<?php echo $_S1; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Anzeige ob Anwesend oder Abwesend (gr&uuml;n oder rot)</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="02" value="1"<?php echo $_S2; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Letzte Stempelzeit von Heute anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="03" value="1"<?php echo $_S3; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Alle Stempelzeiten von Heute anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="04" value="1"<?php echo $_S4; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Bid des Users anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="05" value="1"<?php echo $_S5; ?>>
            </td>
        </tr>
    </table>
    <table width="100%" border="0">
        ...
        <tr>
            <td class="td_background_tag">Anzeige des Usernamens</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="11" value="1"<?php echo $_S11; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Anzeige ob Anwesend oder Abwesend (gr&uuml;n oder rot)</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="12" value="1"<?php echo $_S12; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Letzte Stempelzeit von Heute anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="13" value="1"<?php echo $_S13; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Alle Stempelzeiten von Heute anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="14" value="1"<?php echo $_S14; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Bid des Users anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="15" value="1"<?php echo $_S15; ?>>
            </td>
        </tr>
    </table>
    <table width="100%" border="0">
        <thead>
        <td class="alert alert-error table-danger">Admin - Interface:</td>
        <td class="alert alert-error table-danger" align="center">Anzeige:</td>
        </thead>
        <tr>
            <td class="td_background_tag">Anzeige des Usernamens</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="21" value="1"<?php echo $_S21; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Anzeige ob Anwesend oder Abwesend (gr&uuml;n oder rot)</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="22" value="1"<?php echo $_S22; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Letzte Stempelzeit von Heute anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="23" value="1"<?php echo $_S23; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Alle Stempelzeiten von Heute anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="24" value="1"<?php echo $_S24; ?>>
            </td>
        </tr>
        <tr>
            <td class="td_background_tag">Bid des Users anzeigen</td>
            <td class="td_background_tag" align="center"><input type="checkbox" name="25" value="1"<?php echo $_S25; ?>>
            </td>
        </tr>
    </table>
    <br/>
