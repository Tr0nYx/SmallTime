...
// ----------------------------------------------------------------------------
$t = 1;
if ($_settings->_array[15][1]) {
    $t++;
}
if ($_settings->_array[16][1]) {
    $t++;
}
$a = 1;
...
<div class="table-responsive">
    <table width=100% border=0 cellpadding=3 cellspacing=1>
        <tr>
            <th COLSPAN="3" class="td_background_top" align="center">Datum</th>
            <th COLSPAN="<?php echo $t; ?>" class="td_background_top" align="left">Zeiten</th>
            ...
            <?php if ($_settings->_array[18][1]) {
                echo "<th class='td_background_top' width=16 align=center>Do</th>";
            } ?>
        </tr>
        <?php
        for ($z = 1; $z < count($_monat->_MonatsArray); $z++) {
            ...
            //-------------------------------------------------------------------------
            if ($_settings->_array[16][1] == 1 && $edit) {
                echo " <td ".$_monat->_MonatsArray[$z][30]." class='d-none d-sm-block' width=16 align=center><a href='?action=add_time_list&timestamp=".$_monat->_MonatsArray[$z][0].$modal."' title='mehrere Zeiten hinzuf&uuml;gen'><img border='0' src='images/icons/time_go.png'></a></td>\n";
            }
            if ($_settings->_array[16][1] == 1 && !$edit) {
                echo " <td ".$_monat->_MonatsArray[$z][30]." width=16 align=center></td>\n";
            }
        ...
        <tr>
            ...
            <td COLSPAN=<?php echo $t; ?> class=td_background_info width=550 align=left>Sollstunden:
                <?php echo $_monat->_SummeSollProMonat; ?> Std.
            </td>
            <td class=td_background_info width=40
            ...
            <td COLSPAN=<?php echo $a; ?> class=td_background_info width=50
                align=center><?php echo $_monat->_SummeAbsenzProMonat ?></td>
            <?php
            if ($_settings->_array[18][1]) {
                echo "<td class=td_background_info width=16 align=center> </td>";
            }
            ?>
        </tr>
    </table>
