...
if (isset($_GET['json'])) {
    ...
    for ($x = 0; $x < $anzMA; $x++) {
        ...
        $hash = sha1($tmparr[$x]['pfad'].$tmparr[$x]['passwort'].crypt($tmparr[$x]['pfad'],
                '$2y$04$'.substr($idtime_secret.$tmparr[$x]['passwort'], 0, 22)));
    ...
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Ubuntu+Mono:400,400italic,700italic,700' rel='stylesheet'
              type='text/css'>
