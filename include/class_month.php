    ...
    private function set_monatsdaten($monat, $jahr)
    {
        ...
        for ($i = 1; $i <= $this->_letzterTag; $i++) {
            ...
            if ($this->_MonatsArray[$i][15] == 1 and $tmp1 == 1) {
                $this->_MonatsArray[$i][18] = round(($this->_MonatsArray[$i][8] - $this->_MonatsArray[$i][13]) * $this->_MonatsArray[$i][17] / 100,
                    2);
                $this->_MonatsArray[$i][15] = round(($this->_MonatsArray[$i][8] - $this->_MonatsArray[$i][13]) / $this->_MonatsArray[$i][8],
                    2);
                $this->_MonatsArray[$i][15] = round($this->_MonatsArray[$i][15] * $this->_MonatsArray[$i][4], 2);
            ...
            if ($this->_MonatsArray[$i][14] == "F") {
                $this->_SummeFerien = $this->_SummeFerien + $this->_MonatsArray[$i][15];
            }
            if ($this->_MonatsArray[$i][14] == "K") {
                $this->_SummeKrankheit = $this->_SummeKrankheit + $this->_MonatsArray[$i][15];
            }
            if ($this->_MonatsArray[$i][14] == "U") {
                $this->_SummeUnfall = $this->_SummeUnfall + $this->_MonatsArray[$i][15];
            }
            if ($this->_MonatsArray[$i][14] == "M") {
                $this->_SummeMilitaer = $this->_SummeMilitaer + $this->_MonatsArray[$i][15];
            }
            if ($this->_MonatsArray[$i][14] == "I") {
                $this->_SummeIntern = $this->_SummeIntern + $this->_MonatsArray[$i][15];
            }
            if ($this->_MonatsArray[$i][14] == "W") {
                $this->_SummeWeiterbildung = $this->_SummeWeiterbildung + $this->_MonatsArray[$i][15];
            }
            if ($this->_MonatsArray[$i][14] == "E") {
                $this->_SummeExtern = $this->_SummeExtern + $this->_MonatsArray[$i][15];
            }
            //------------------------------------------------------------------alte Abwesenheitsberechnungen
        }
    }
    ...
    private function get_time($i)
    {
        ...
        for ($h = 0; $h < $_count; $h = $h + 2) {
            ...
            if (isset($_stempelzeit[$h + 1]) and $_stempelzeit[$h + 1] <> 0) {
                ...
                $Stempel2 = (date("H", $_stempelzeit[$h + 1]) * 100 + date("i",
                            $_stempelzeit[$h + 1]) * 100 / 60) / 100;
                if ($_debug) {
